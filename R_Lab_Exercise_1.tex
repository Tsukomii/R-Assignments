...
\FunctionTok{paste}\NormalTok{(}\StringTok{"Data type of variable a: "}\NormalTok{, }\FunctionTok{typeof}\NormalTok{(a))}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
## [1] "Data type of variable a:  integer"
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{paste}\NormalTok{(}\StringTok{"Data type of variable b: "}\NormalTok{, }\FunctionTok{typeof}\NormalTok{(b))}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
## [1] "Data type of variable b:  double"
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{paste}\NormalTok{(}\StringTok{"Data type of variable c: "}\NormalTok{, }\FunctionTok{typeof}\NormalTok{(c))}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
## [1] "Data type of variable c:  character"
\end{verbatim}
...
\CommentTok{\# Enter your code here!}
\FunctionTok{paste}\NormalTok{(}\StringTok{"Data type of variable d: "}\NormalTok{, }\FunctionTok{typeof}\NormalTok{(d))}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
## [1] "Data type of variable d:  double"
\end{verbatim}
...
\begin{Highlighting}[]
\CommentTok{\# Enter your code here.}
\NormalTok{vAlphabet }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(letters)}
\NormalTok{vAlphabet}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mAlphabet }\OtherTok{\textless{}{-}} \FunctionTok{matrix}\NormalTok{(LETTERS, }\AttributeTok{nrow=}\DecValTok{13}\NormalTok{)}
\NormalTok{mAlphabet}
\end{Highlighting}
\end{Shaded}
